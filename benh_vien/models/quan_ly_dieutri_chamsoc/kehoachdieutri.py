...
class Kehoachdieutri(models.Model):
    ...
    ma_bac_si = fields.Many2one("benhvien.nhansu", string="Tên bác sĩ điều trị", required=True)
    ...
    tientrinh = fields.One2many(
        "benhvien.tientrinh",
        "ma_ke_hoach",
        string="Danh sách tien trinh"
    )
